...
#include "../../src/customstyleCleanPushbutton.h"
...
QT_INIT_METAOBJECT const QMetaObject customstyle_clean_pushbutton::staticMetaObject = { {
    &QProxyStyle::staticMetaObject,
    qt_meta_stringdata_customstyle_clean_pushbutton.data,
    qt_meta_data_customstyle_clean_pushbutton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
