...
#include "../../../../src/plugins/ukui-sidebar-clipboard/customstylePushbutton2.h"
...
const QMetaObject CustomStyle_pushbutton_2::staticMetaObject = {
    { &QProxyStyle::staticMetaObject, qt_meta_stringdata_CustomStyle_pushbutton_2.data,
      qt_meta_data_CustomStyle_pushbutton_2,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CustomStyle_pushbutton_2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomStyle_pushbutton_2.stringdata0))
        return static_cast<void*>(const_cast< CustomStyle_pushbutton_2*>(this));
