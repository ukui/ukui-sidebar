...
void MonitorThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MonitorThread::*_t)(QString , QString , QString , QString , QDateTime , int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MonitorThread::Sig_Notify)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MonitorThread::*_t)(QString , QString , QString , QString , QDateTime , int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MonitorThread::Sig_Takein)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MonitorThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MonitorThread::Sig_CloseAppMsg)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (MonitorThread::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MonitorThread::Sig_UpdateAppMaxNum)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject MonitorThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_MonitorThread.data,
      qt_meta_data_MonitorThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
