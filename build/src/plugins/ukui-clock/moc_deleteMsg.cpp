...
void delete_msg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<delete_msg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject delete_msg::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_delete_msg.data,
    qt_meta_data_delete_msg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
