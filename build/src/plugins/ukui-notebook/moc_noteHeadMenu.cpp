...
#include "../../../../src/plugins/ukui-notebook/noteHeadMenu.h"
...
const QMetaObject noteHeadMenu::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_noteHeadMenu.data,
      qt_meta_data_noteHeadMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *noteHeadMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_noteHeadMenu.stringdata0))
        return static_cast<void*>(const_cast< noteHeadMenu*>(this));
