...
#include "../../../../src/plugins/ukui-notebook/paletteWidget.h"
...
const QMetaObject PaletteWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PaletteWidget.data,
      qt_meta_data_PaletteWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PaletteWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PaletteWidget.stringdata0))
        return static_cast<void*>(const_cast< PaletteWidget*>(this));
