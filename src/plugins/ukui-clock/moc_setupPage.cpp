...
void setuppage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<setuppage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject setuppage::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_setuppage.data,
    qt_meta_data_setuppage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
