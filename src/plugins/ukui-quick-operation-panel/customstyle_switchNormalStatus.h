...
class customstyle_switchNormalStatus : public QProxyStyle
{
    Q_OBJECT
public:
    explicit customstyle_switchNormalStatus(const QString &proxyStyleName = "windows", QObject *parent = nullptr);
