...
class CustomStyle_SwitchOpenStatus : public QProxyStyle
{
    Q_OBJECT
public:
    explicit CustomStyle_SwitchOpenStatus(const QString &proxyStyleName = "windows", QObject *parent = nullptr);
